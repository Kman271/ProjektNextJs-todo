...
export default async function CheckList({userToken, data} : {userToken: string, data: noteJsonType[] }) {

    return (
        <div className='h-full w-full flex items-start justify-center'>
            <div className='relative basis-[80rem] min-h-[25rem] max-h-[60vh] bg-gray-900 border-[1rem] border-transparent flex-shrink bg-clip-padding rounded-md
